export default function VkIcon() {
    return (
        ...
        >
            <rect width="100%" height="100%" className={"transition-all group-hover:stroke-[#5281b8] group-hover:fill-[#5281b8] stroke-[6px] stroke-white fill-transparent "} rx="15%"></rect>
            <path
                fill="#fff"
